#!/usr/bin/env bash
# Infra Automation ansible-vault command
#
# Usage: ./infra-automation ansible-vault ENVIRONMENT COMMAND
#
...
ENVIRONMENTS:
     production             Create Secret keys for Vault in ${ROOT_PATH}/ansible/vault_keys/
